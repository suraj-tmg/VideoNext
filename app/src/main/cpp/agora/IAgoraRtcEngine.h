...
struct VideoCompositingLayout
{
    struct Region {
        ...
        double x;//[0,oneImage]
        double y;//[0,oneImage]
        double width;//[0,oneImage]
        double height;//[0,oneImage]
        int zOrder; //optional, [0, 100] //0 (default): bottom most, 100: top most

        //  Optional
        //  [0, oneImage.0] where 0 denotes throughly transparent, oneImage.0 opaque
        double alpha;
...
//        return setObject("rtc.video.set_remote_video_stream", "{\"uid\":%u,\"stream\":%d}", uid, streamType);
	...
	*        -oneImage, infinite loop playback
	* @return return 0 if success or an error code
	*/
	...
	*/
     ...
     * @param [in] pitch
     *        frequency, in the range of [0.5..2.0], default value is oneImage.0
     *
     * @return return 0 if success or an error code
     */
